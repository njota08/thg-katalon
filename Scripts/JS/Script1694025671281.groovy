...
WebUI.click(findTestObject('Object Repository/Page_Resources - Best Practices/a_Best Practices'))

WebUI.takeFullPageScreenshotAsCheckpoint('test1', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_Resources - Best Practices/a_Load More'))
